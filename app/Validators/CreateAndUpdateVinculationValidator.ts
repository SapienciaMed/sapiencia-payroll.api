...
export default class CreateAndUpdateWorkerValidator {
  ...
  public schema = schema.create({
    worker: schema.object().members({
      ...
      bank: schema.string.optional([rules.maxLength(10)]),
      accountBankType: schema.string.optional([rules.maxLength(10)]),
      accountBankNumber: schema.string.optional([rules.maxLength(10)]),
